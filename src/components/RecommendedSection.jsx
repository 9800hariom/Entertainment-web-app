...
const RecommendedSection = () => {
  ...
  const handlecard=(movie)=>{
    ...
    console.log(movie)  }
    const url = "https://api.themoviedb.org/3/movie/upcoming?api_key=32292ae8d1bf55d5897004876adcf77f";
  const options = {
    method: "GET",
    headers: {
  ...
  return (
    <div className="p-6">
      ...
      <h2 className="text-white text-5xl mb-7 font-semibold ">upcoming Now</h2>
